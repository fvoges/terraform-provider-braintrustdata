# braintrustdata_prompts Example

This folder contains runnable Terraform examples for braintrustdata_prompts.
...
Run:
1. cd examples/data-sources/braintrustdata_prompts
