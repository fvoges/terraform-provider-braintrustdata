# braintrustdata_experiments Example

This folder contains runnable Terraform examples for braintrustdata_experiments.
...
Run:
1. cd examples/data-sources/braintrustdata_experiments
