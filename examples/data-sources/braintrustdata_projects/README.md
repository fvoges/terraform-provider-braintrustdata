# braintrustdata_projects Example

This folder contains runnable Terraform examples for braintrustdata_projects.
...
Run:
1. cd examples/data-sources/braintrustdata_projects
