# braintrustdata_datasets Example

This folder contains runnable Terraform examples for braintrustdata_datasets.
...
Run:
1. cd examples/data-sources/braintrustdata_datasets
