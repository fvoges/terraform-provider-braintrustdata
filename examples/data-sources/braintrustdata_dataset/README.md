# braintrustdata_dataset Example

This folder contains runnable Terraform examples for braintrustdata_dataset.
...
Run:
1. cd examples/data-sources/braintrustdata_dataset
