# braintrustdata_experiment Example

This folder contains runnable Terraform examples for braintrustdata_experiment.
...
Run:
1. cd examples/data-sources/braintrustdata_experiment
