# braintrustdata_functions Example

This folder contains runnable Terraform examples for braintrustdata_functions.
...
Run:
1. cd examples/data-sources/braintrustdata_functions
2. terraform init -backend=false
3. terraform validate
4. terraform plan

Notes:
- Supported filters: `project_id`, `name` (maps to API `function_name`), `slug`, `limit`, `starting_after`, `ending_before`.
