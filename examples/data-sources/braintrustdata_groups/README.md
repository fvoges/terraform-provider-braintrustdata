# braintrustdata_groups Example

This folder contains runnable Terraform examples for braintrustdata_groups.
...
Run:
1. cd examples/data-sources/braintrustdata_groups
