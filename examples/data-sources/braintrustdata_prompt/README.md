# braintrustdata_prompt Example

This folder contains runnable Terraform examples for braintrustdata_prompt.
...
Run:
1. cd examples/data-sources/braintrustdata_prompt
